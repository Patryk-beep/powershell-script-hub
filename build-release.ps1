...
foreach ($mod in @('Hub-Workflows.ps1', 'Hub-WorkflowEngine.ps1', 'Hub-Triggers.ps1', 'Hub-Git.ps1', 'Hub-History.ps1', 'Hub-Presets.ps1', 'Hub-Secrets.ps1', 'Hub-Export.ps1')) {
...
$expectedFiles = @('Hub.exe', 'Hub.ico', 'README.md', 'wwwroot\index.html', 'wwwroot\app.js', 'wwwroot\style.css',
                   ...
                   'Hub-Secrets.ps1', 'Hub-Export.ps1')

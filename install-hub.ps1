...
$Script:ExpectedZipHash = 'A12FBF401ABCB7A465C4D990625CF1ADE0B0008C00197E2DCC295E02E431DA58'
    ...
    try {
        ...
        if ($status -eq 403) {
            ...
            if ($body -match 'API rate limit exceeded') {
                throw "GitHub API rate-limited. Try again in ~1 hour, or pass -Version v1.7.0.0 to skip 'latest' lookup."
            }
